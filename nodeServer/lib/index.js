const { CookeObj, libList, saveLibDataAsync } = require("./myCookie.js");
...
async function setCookieController(ctx) {
  ...
  if (newCookie) {
    if (!newCookie.includes("Authorization") || !newCookie.includes("SERVERID")) {
      ctx.body = {
        code: 1,
        msg: "无效的Cookie格式，请确保Cookie包含'Authorization'和'SERVERID'",
      };
      return;
    }
 ...
 * @todo This function needs to be reviewed for security vulnerabilities.
 */
