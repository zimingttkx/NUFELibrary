...
### Windows 平台
- **双击启动.bat** - 🌟 **推荐！零配置一键启动**（自动安装环境+依赖+启动）
- **start.bat** - 一键启动脚本（需要先有Node.js）
- **install.bat** - 安装依赖脚本（仅安装依赖）
- **stop.bat** - 一键停止脚本

### Linux/Mac 平台
- **双击启动.sh** - 🌟 **推荐！零配置一键启动**（自动安装环境+依赖+启动）
- **start.sh** - 一键启动脚本（需要先有Node.js）
- **install.sh** - 安装依赖脚本（仅安装依赖）
- **stop.sh** - 一键停止脚本
