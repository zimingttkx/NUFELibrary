...
- **step1:** **_抓包获取 Cookie_**
  ...
  ![抓包示例](https://img-blog.csdnimg.cn/direct/1d95392a511448fc857d0a11325a001e.png)

- **step2:** **_设置 Cookie_**

  - **_1.通过仓库配套的前端页面设置(推荐)⭐⭐⭐:_**
    ![设置示例](https://img-blog.csdnimg.cn/direct/87a708f2c5d64af9a9f8c13e29550273.png)
...
- (**step3:**) **_获取可选场馆列表_**（首次使用时执行一次即可）**_【需要 Cookie 有效】_**
  ...
  - **_1.通过配套前端页面设置(推荐)⭐⭐⭐:_**
    ![设置示例](https://img-blog.csdnimg.cn/direct/6ba29e4f2a8241d6a9dd30ed48a10949.png)
...
- (**step4:**) **_选择场馆 + 设置座位号_** **_【需要 Cookie 有效】_**
  ...
  - **_1.通过配套前端页面设置(推荐)⭐⭐⭐:_**
    ...
    ![设置示例](https://img-blog.csdnimg.cn/direct/a063ce1c7f114ac2b6dd1dbdb9e0e986.png)
...
![演示](https://img-blog.csdnimg.cn/direct/2a0f5ec070024dcbb44a55f0a2ace943.gif)
