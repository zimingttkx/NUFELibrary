...
- **step1:** **_抓包获取 Cookie_**
  ...
  ![](https://gitee.com/suchongyuan/I_Goto_Library/blob/main/images/getCookie.png)

- **step2:** **_设置 Cookie_**

  - **_1.通过仓库配套的前端页面设置(推荐)⭐⭐⭐:_**
    ![](https://gitee.com/suchongyuan/I_Goto_Library/blob/main/images/setCookie.png)
...
- (**step3:**) **_获取可选场馆列表_**（首次使用时执行一次即可）**_【需要 Cookie 有效】_**
  ...
  - **_1.通过配套前端页面设置(推荐)⭐⭐⭐:_**
    ![](https://gitee.com/suchongyuan/I_Goto_Library/blob/main/images/refreshButton.png)
...
- (**step4:**) **_选择场馆 + 设置座位号_** **_【需要 Cookie 有效】_**
  ...
  - **_1.通过配套前端页面设置(推荐)⭐⭐⭐:_**
    ...
    ![](https://gitee.com/suchongyuan/I_Goto_Library/blob/main/images/changeSeat.png)
...
![](https://gitee.com/suchongyuan/I_Goto_Library/blob/main/images/run.gif)
